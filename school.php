...
<h1 style="text-align: center; color: green">Teachers for College Section</h1>

  <div class="card-columns">
    <div class="card-body text-center">
        <div class="cardt" style="width:400px">
          <img class="card-img-top" src="images/principle.jpg" alt="Card image" style="width:50%">
          <div class="card-body">
            <h4 class="card-title">Mamunur Rashid Alex</h4>
            <p class="card-text">Head Teacher<br>
              BSc. (Engg) in CSE, SEU
            </p>
      ...
      <div class="card-body text-center">
        <div class="cardt" style="width:400px">
          ...
          <div class="card-body">
            <h4 class="card-title">Mamunur Rashid Alex</h4>
            <p class="card-text">Assistant Teacher<br>
              BSc. (Engg) in CSE, SEU
            </p>
            <a href="#" class="btn btn-primary">See Profile</a>
          </div>
      ...
      <div class="card-body text-center">
        <div class="cardt" style="width:400px">
          ...
          <div class="card-body">
            <h4 class="card-title">Mamunur Rashid Alex</h4>
            <p class="card-text">Assistant Head Teacher<br>
              BSc. (Engg) in CSE, SEU
            </p>
            <a href="#" class="btn btn-primary">See Profile</a>
          </div>
      ...
      <div class="card-body text-center">
        <div class="cardt" style="width:400px">
          ...
          <div class="card-body">
            <h4 class="card-title">Mamunur Rashid Alex</h4>
            <p class="card-text">Junior Teacher<br>
              BSc. (Engg) in CSE, SEU
            </p>
            <a href="#" class="btn btn-primary">See Profile</a>
          </div>
